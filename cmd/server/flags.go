...
var flags = append([]cli.Flag{
	...
	&cli.StringFlag{
		EnvVars:  []string{"WOODPECKER_RADICLE_SESSION_TOKEN"},
		Name:     "radicle-session-token",
		Usage:    "radicle node session token",
		FilePath: os.Getenv("WOODPECKER_RADICLE_SESSION_TOKEN"),
	},
	//
	// development flags
	//
